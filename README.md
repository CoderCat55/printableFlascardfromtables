...
coulumn 1 = image
coulmn 2 = word about image

but adding image to excel file is hard. So I need a program which will run on google colab, 
this program should be able to used by people who dont know any technical details, therefore we might need these libraries from google.colab import files
import ipywidgets as widgets from IPython.display import display, clear_output, HTML 
